...
// ============================================================
// DISPLAY SELECTION FOR ARDUINO IDE
// Choose ONE:
// ============================================================

// I2C monochrome SSD1306 only:
#define DISPLAY_BACKEND_SSD1306 1

// SPI color SSD1331 only:
// #define DISPLAY_BACKEND_SSD1331 1

// Mirror to both SSD1306 + SSD1331:
// #define DISPLAY_BACKEND_MIRROR 1

#define OLED_SSD1331_MASTER_CURRENT 0x0F
#define OLED_SSD1331_CONTRAST_A 0xFF
#define OLED_SSD1331_CONTRAST_B 0xFF
#define OLED_SSD1331_CONTRAST_C 0xFF
